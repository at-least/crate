 ...
 */
class MuWidget : GlanceAppWidget() {
        ...
        GlanceTheme {
            Column(
                ...
                if (state == NowPlayingSnapshot.DisplayState.IDLE) {
                    Text("Mu", style = TextStyle(fontWeight = FontWeight.Bold, fontSize = 16.sp))
...
class MuWidgetReceiver : GlanceAppWidgetReceiver() {
    override val glanceAppWidget: GlanceAppWidget = MuWidget()
}
