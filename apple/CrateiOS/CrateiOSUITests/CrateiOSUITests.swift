...
final class CrateiOSUITests: XCTestCase {

    private var lib: URL!

    override func setUpWithError() throws {
        continueAfterFailure = false
        let repo = URL(fileURLWithPath: #filePath)     // …/apple/CrateiOS/CrateiOSUITests/CrateiOSUITests.swift
            .deletingLastPathComponent()               // CrateiOSUITests
            .deletingLastPathComponent()               // CrateiOS
        ...
        lib = FileManager.default.temporaryDirectory
            .appendingPathComponent("crate-uitest-\(UUID().uuidString)")
